...
# 加速地址
git clone https://mirrors.decodeaz.online/https://github.com/maoshengyzx/cloudflare-proxy.git

# 下载Release包
wget https://mirrors.decodeaz.online/https://github.com/maoshengyzx/cloudflare-proxy/releases/download/v1.0.0/release.zip
```
...
{
  "registry-mirrors": ["https://mirrors.decodeaz.online"]
}
EOF
